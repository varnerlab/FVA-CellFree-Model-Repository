...
data_dictionary["species_drift_constant"] = 0.05 # percent allowed to drift for unconstraint species for each iteration (0.01 hr)
...
species_constraint_index = [60,15,21,83,114,31,140]
