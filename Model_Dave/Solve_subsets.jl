...
species_constraint_array = zeros(25,38)
Labels = String[]
for i in 1:size(species_constraint_array,1)
	species_constraint_array[i,1:end-1] = dataset_index
	species_constraint_array[i,end] = single_species_additions[i,1]
	push!(Labels,"Plus_"*single_species_additions[i,2])
end
