...
data = readdlm("updated_FVA/combined_data_SA_238ens",'\t')
...
no_glc = Array{Int64}(readdlm("updated_FVA/no_glc"))
no_g6p = Array{Int64}(readdlm("updated_FVA/no_g6p"))
