...
function PlotSeparate(plot_color)
...
for i in 1:size(carbon_species,1)
	for j in 1:size(carbon_species,2)
		...
		# Plot synthetic data
		shade_color = (species_index in species_constraint_index)?"lightblue":"lightgray"
