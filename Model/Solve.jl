...
#	end
#end
writedlm("Results/Oct11/species_constraint_labels",Labels)
writedlm("Results/Oct11/species_constraint_array",species_constraint_array)
...
#		            @show flux_array
	...
	accuracy = 1/sum(error);println(accuracy)
...
writedlm("Results/Oct11/EXIT_FLAG",EXIT_FLAG)
writedlm("Results/Oct11/Accuracy",Accuracy)
writedlm("Results/Oct11/Precision",Precision)
