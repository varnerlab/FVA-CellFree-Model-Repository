...
data_dictionary = DataDictionary(0,0,0)
#Set objective reaction
data_dictionary["objective_coefficient_array"][191] = -1;
data_dictionary["AASyn"] = 100;
data_dictionary["AAUptake"] = 30
data_dictionary["AASecretion"] = 0;
...
for constraint_index in 1:1#constraint_index_array[1] ;println(Labels[constraint_index])
...
#	FVA_min = ones(300,191,25)*999
#	FVA_max = zeros(300,191,25)
#	for rxn_idx in 1:191
